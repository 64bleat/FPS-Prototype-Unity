...
namespace MPCore
{
    ...
    public class HUDViewModel : MonoBehaviour
    {
        ...
        void OnDestroy()
        {
            ...
            _saveModel.OnPostLoad.RemoveListener(MessageQuickLoad);
            _saveModel.OnPostSave.RemoveListener(MessageQuickSave);
        }
        ...
        void MessageQuickSave() => DisplayLargeMessage(new DeltaValue<string>(string.Empty, "Quicksaved"));
        void MessageQuickLoad() => DisplayLargeMessage(new DeltaValue<string>(string.Empty, "Quickloaded"));
