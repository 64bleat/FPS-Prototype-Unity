...
namespace MPCore
{
    ...
    {   
        ...
        private GameSelectModel _gameSelect;
        ...
        private void Awake()
        {
            _gameSelect = Models.GetModel<GameSelectModel>();
        ...
        private void Update()
        {
            if (_gameSelect)
            {
                ...
                {
                    int index = _loadedPlayers.Count % _gameSelect.botList.Count;
                    ConnectPlayer(_gameSelect.botList[index], false);
                }
        ...
        void ConnectPlayer(CharacterInfo character, bool isPlayer)
        {
            ...
            else
            {
                ...
                int repeat = i / _gameSelect.botList.Count;
