...
namespace MPGUI
{
    public class QualitySettingManager : ScriptableObject
    {
        ...
        //public void SetFullScreenMode(RectTransform parent)
        //{
        //    ButtonSet set = dropdown.SpawnDropdown(parent);
        ...
        //        void call() => Screen.fullScreenMode = mode;
        //        GameObject go = set.AddButton(mode.ToString(), call);
        ...
        //{
        //    ButtonSet set = dropdown.SpawnDropdown(rect);
        ...
        public void OpenGUIScaleDropdown(RectTransform button)
        {
            ButtonSet set = dropdown.SpawnDropdown(button);
            CanvasScaler scaler = button.GetComponentInParent<CanvasScaler>();
