...
namespace MPCore
{
	public struct SplayedMesh
	{
		...
		public SplayedMesh(Mesh mesh, Transform transform)
		{
		...
		static NativeArray<Vector3> MakeTirangleNormals(NativeArray<int> triangles, NativeArray<Vector3> vertices)
		{
		...
		static NativeArray<Vector3> MakeCenters(NativeArray<int> triangles, NativeArray<Vector3> vertices)
		{
		...
		static Dictionary<Vector3, HashSet<int>> MakeDuplicates(NativeArray<int> triangles, NativeArray<Vector3> vertices)
		{
		...
		static NativeArray<int> MakeNeighbors(NativeArray<int> triangles, NativeArray<Vector3> vertices)
		{
