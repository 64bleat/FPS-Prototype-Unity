    ...
    public class InputManager : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            if (isPlayer)
            {
                ...
                if (_canvasScaler)
                    mousePositionDelta /= _canvasScaler.scaleFactor;
        ...
        private float GetMouseAxis(string axis)
        {
            ...
            return robotAxis + (!keyMasks.Contains("Ingame") ? (isPlayer ? Input.GetAxis(axis) : 0f) * _keyModel.mouseSensitivity : 0);
        }
    }
}
